...
cp -r ./bower_components/foundation-sites/scss ./app/_assets/scss/foundation
rm -f ./app/_assets/scss/foundation/foundation.scss
cp ./bower_components/foundation-sites/scss/foundation.scss ./app/_assets/scss/foundation/_foundation.scss
