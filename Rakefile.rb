...
namespace :notify do
  ...
  task :pingomatic do
    begin
      ...
      XMLRPC::Client.new('rpc.pingomatic.com', '/').call('weblogUpdates.extendedPing', 'my-website.com' , '//my-website.com', '//my-website.com/atom.xml')
    rescue LoadError
  ...
  task :google do
    begin
      ...
      Net::HTTP.get('www.google.com', '/webmasters/tools/ping?sitemap=' + URI.escape('//my-website.com/sitemap.xml'))
    rescue LoadError
  ...
  task :bing do
    begin
      ...
      Net::HTTP.get('www.bing.com', '/webmaster/ping.aspx?siteMap=' + URI.escape('//my-website.com/sitemap.xml'))
    rescue LoadError
